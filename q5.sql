...
/* ANSWER
Bottleneck - full table scans on course, fixed with indexing.
Solution, introduce indexes for Course table. 
The other answer would be to do a left Join on the v7 = NULL */