...
/* ANSWER +++
Bottleneck, full table scans on all tables.
Solution: Indexing - while unable to force the join to use an index, the other 3 indexes worked and lowered the cost
at least 20% */